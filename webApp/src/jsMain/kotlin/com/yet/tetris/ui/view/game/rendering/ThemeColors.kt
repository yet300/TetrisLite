...
object ThemeColors {
    fun getTetrominoColor(type: TetrominoType, settings: GameSettings): String {
    ...
    fun getTetrominoLightColor(type: TetrominoType, settings: GameSettings): String {
        val baseColor = getTetrominoColor(type, settings)
        return lightenColorHex(baseColor, 0.3)
    }

    fun getTetrominoDarkColor(type: TetrominoType, settings: GameSettings): String {
        val baseColor = getTetrominoColor(type, settings)
