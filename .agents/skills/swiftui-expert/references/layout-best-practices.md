...
**Why**: Hard-coded values don't account for different screen sizes, orientations, or dynamic
content (like status bars during phone calls).
...
**Note**: This is about separating business logic for testability, not about enforcing specific
architectures like MVVM. The goal is to make logic testable while keeping views simple.
