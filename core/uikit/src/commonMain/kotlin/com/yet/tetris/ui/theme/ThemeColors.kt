 ...
 */
fun ThemeConfig.getTetrominoComposeColor(type: TetrominoType): Color = visualTheme.getTetrominoColor(type)

/**
 * Get Compose Color for the background from ThemeConfig
 */
fun ThemeConfig.getBackgroundComposeColor(): Color = visualTheme.getBackgroundColor()

/**
 * Get Compose Color for grid lines from ThemeConfig
 */
fun ThemeConfig.getGridComposeColor(): Color = visualTheme.getGridColor()

/**
 * Get all tetromino colors for the current theme as a map
 */
fun ThemeConfig.getAllTetrominoColors(): Map<TetrominoType, Color> =
    TetrominoType.entries.associateWith { type ->
 ...
 */
fun ThemeConfig.getTetrominoLightColor(
    type: TetrominoType,
    factor: Float = 0.3f,
): Color {
 ...
 */
fun ThemeConfig.getTetrominoDarkColor(
    type: TetrominoType,
    factor: Float = 0.3f,
): Color {
    val baseColor = getTetrominoComposeColor(type)
 ...
 */
fun ThemeConfig.getGhostPieceColor(
    type: TetrominoType,
    alpha: Float = 0.3f,
): Color {
    val baseColor = getTetrominoComposeColor(type)
