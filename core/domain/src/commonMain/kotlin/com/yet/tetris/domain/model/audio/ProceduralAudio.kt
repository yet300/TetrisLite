...
object SoundEffectPresets {
    ...
    val PIECE_MOVE = SoundEffectParams(
    ...
    val PIECE_ROTATE = SoundEffectParams(
    ...
    val PIECE_DROP = SoundEffectParams(
        waveform = WaveformType.SQUARE,
        startFrequency = 150f,
        endFrequency = 80f,
        duration = 0.15f,
    ...
    val LINE_CLEAR = SoundEffectParams(
    ...
    val GAME_OVER = SoundEffectParams(
        waveform = WaveformType.TRIANGLE,
        startFrequency = 440f,
        endFrequency = 110f,
        duration = 1.0f,
...
object MusicSequencePresets {
     ...
     */
    val CLASSIC_THEME = MusicSequence(
        notes = listOf(
            // Phrase 1
     ...
     */
    val MODERN_THEME = MusicSequence(
        notes = listOf(
            Note(Note.C5, Note.EIGHTH),
