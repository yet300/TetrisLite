...
class RotatePieceUseCase(
     ...
     */
    private fun getWallKickOffsets(from: Tetromino, to: Tetromino): List<Position> {
        return if (from.type == com.yet.tetris.domain.model.game.TetrominoType.I) {
     ...
     */
    private fun getStandardKickOffsets(fromRotation: Int, toRotation: Int): List<Position> {
        return when (fromRotation to toRotation) {
     ...
     */
    private fun getIKickOffsets(fromRotation: Int, toRotation: Int): List<Position> {
        return when (fromRotation to toRotation) {
