...
class GameStateDaoTest: RobolectricTestRunner() {
    ...
    @Test
    fun saveGameState_shouldSaveCompleteGameState() = runTest {
        // Given
    ...
    @Test
    fun saveGameState_shouldReplaceExistingState() = runTest {
        // Given
    ...
    @Test
    fun getGameState_shouldReturnNullWhenNoStateSaved() = runTest {
        // When
        val state = dao.getGameState()
    ...
    @Test
    fun getBoardCells_shouldReturnEmptyListWhenNoStateSaved() = runTest {
        // When
        val cells = dao.getBoardCells()
    ...
    @Test
    fun clearGameState_shouldRemoveStateAndCells() = runTest {
        // Given
        val boardCells = listOf(
            BoardCells(positionX = 0, positionY = 0, pieceType = TetrominoType.I)
        )
    ...
    @Test
    fun hasSavedState_shouldReturnTrueWhenStateExists() = runTest {
        // Given
        dao.saveGameState(
            score = 1000,
            linesCleared = 10,
    ...
    @Test
    fun hasSavedState_shouldReturnFalseWhenNoStateExists() = runTest {
        // When
        val hasSaved = dao.hasSavedState()
    ...
    @Test
    fun observeGameState_shouldEmitUpdates() = runTest {
        // When/Then
    ...
    @Test
    fun saveGameState_withNullCurrentPiece_shouldSaveCorrectly() = runTest {
        // When
        dao.saveGameState(
            score = 500,
            linesCleared = 5,
