...
class GameHistoryDaoTest : RobolectricTestRunner() {
    ...
    @Test
    fun insertGame_shouldSaveGameToDatabase() = runTest {
        // Given
    ...
    @Test
    fun getAllGames_shouldReturnAllGamesOrderedByTimestamp() = runTest {
        // Given
    ...
    @Test
    fun observeAllGames_shouldEmitUpdates() = runTest {
        // Given
    ...
    @Test
    fun getGameById_shouldReturnNullForNonExistentGame() = runTest {
        // When
    ...
    @Test
    fun deleteGame_shouldRemoveGameFromDatabase() = runTest {
        // Given
        val game = createTestGame(id = "1", score = 1000)
        dao.insertGame(game)
    ...
    @Test
    fun clearAllGames_shouldRemoveAllGames() = runTest {
        // Given
    ...
    @Test
    fun getGamesCount_shouldReturnCorrectCount() = runTest {
        // Given
        dao.insertGame(createTestGame(id = "1", score = 1000))
        dao.insertGame(createTestGame(id = "2", score = 2000))
    ...
    @Test
    fun deleteOldestGames_shouldRemoveOldestGamesByTimestamp() = runTest {
        // Given
