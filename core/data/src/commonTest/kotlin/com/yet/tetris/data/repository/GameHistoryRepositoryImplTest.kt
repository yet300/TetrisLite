...
class GameHistoryRepositoryImplTest : RobolectricTestRunner() {
    ...
    @Test
    fun saveGame_shouldSaveGameRecord() = runTest {
        // Given
    ...
    @Test
    fun saveGame_shouldLimitHistoryTo100Games() = runTest {
    ...
    @Test
    fun getAllGames_shouldReturnAllGames() = runTest {
        // Given
    ...
    @Test
    fun getAllGames_shouldReturnEmptyListOnError() = runTest {
    ...
    @Test
    fun getGameById_shouldReturnGame() = runTest {
        // Given
    ...
    @Test
    fun getGameById_shouldReturnNullForNonExistent() = runTest {
        // When
    ...
    @Test
    fun observeGames_shouldEmitUpdates() = runTest {
        // When/Then
