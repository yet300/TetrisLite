...
class GameSettingsRepositoryImplTest : RobolectricTestRunner() {
    ...
    @Test
    fun getSettings_shouldReturnDefaultWhenNoSettings() = runTest {
        // When
    ...
    @Test
    fun saveSettings_shouldPersistSettings() = runTest {
        // Given
    ...
    @Test
    fun saveSettings_shouldOverwriteExistingSettings() = runTest {
        // Given
    ...
    @Test
    fun observeSettings_shouldEmitUpdates() = runTest {
        // When/Then
    ...
    @Test
    fun getSettings_shouldReturnDefaultOnCorruptedData() = runTest {
    ...
    @Test
    fun saveSettings_shouldPreserveAllFields() = runTest {
        // Given
