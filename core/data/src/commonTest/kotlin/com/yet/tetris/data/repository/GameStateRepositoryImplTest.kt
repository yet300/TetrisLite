...
class GameStateRepositoryImplTest : RobolectricTestRunner() {
    ...
    @Test
    fun saveGameState_shouldSaveCompleteState() = runTest {
        // Given
    ...
    @Test
    fun saveGameState_shouldSaveWithCurrentPiece() = runTest {
        // Given
    ...
    @Test
    fun saveGameState_shouldSaveWithoutCurrentPiece() = runTest {
        // Given
    ...
    @Test
    fun loadGameState_shouldReturnNullWhenNoState() = runTest {
        // When
        val loaded = repository.loadGameState()
    ...
    @Test
    fun clearGameState_shouldRemoveState() = runTest {
        // Given
        val state = createTestGameState()
        repository.saveGameState(state)
    ...
    @Test
    fun hasSavedState_shouldReturnFalseWhenNoState() = runTest {
        // When
        val hasSaved = repository.hasSavedState()
