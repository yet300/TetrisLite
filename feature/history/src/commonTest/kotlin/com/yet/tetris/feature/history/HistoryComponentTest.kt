...
class HistoryComponentTest {
    ...
    @Test
    fun WHEN_created_with_games_THEN_games_displayed() =
        runTest {
            val games =
                listOf(
    ...
    @Test
    fun WHEN_created_THEN_default_filter_is_ALL() =
        runTest {
            val component = createComponent()
            testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun WHEN_onFilterChanged_THEN_filter_updated_in_model() =
        runTest {
    ...
    @Test
    fun WHEN_onFilterChanged_to_TODAY_THEN_only_today_games_shown() =
        runTest {
            val now = Clock.System.now()
            val games =
                listOf(
    ...
    @Test
    fun WHEN_onFilterChanged_to_ALL_THEN_all_games_shown() =
        runTest {
            val now = Clock.System.now()
            val games =
                listOf(
    ...
    @Test
    fun WHEN_onDeleteGame_THEN_game_removed_from_list() =
        runTest {
            val games =
                listOf(
                    createGameRecord(id = "1", score = 100),
    ...
    @Test
    fun WHEN_onRefresh_THEN_games_reloaded() =
        runTest {
    ...
    @Test
    fun WHEN_onDismiss_THEN_dismiss_callback_called() =
        runTest {
    ...
    @Test
    fun WHEN_empty_history_THEN_empty_list_in_model() =
        runTest {
    ...
    @Test
    fun WHEN_filter_changed_multiple_times_THEN_last_filter_active() =
        runTest {
            val now = Clock.System.now()
            val games =
                listOf(
    ...
    @Test
    fun WHEN_delete_all_games_THEN_empty_list() =
        runTest {
            val games =
                listOf(
                    createGameRecord(id = "1", score = 100),
    ...
    private fun createComponent(dismiss: () -> Unit = {}): DefaultHistoryComponent {
