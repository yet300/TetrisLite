...
import com.yet.tetris.database.di.NativeDatabaseBindings
...
internal interface NativeAppGraph : AppGraph

fun createNativeAppGraph(): AppGraph = createGraph<NativeAppGraph>()
